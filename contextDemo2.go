...
func main() {
	...
	fmt.Printf("The value of the key %v found in node3: %v\n", keys[1], node3.Value(keys[1]))
	...
	fmt.Printf("The value of the key %v found in node6Branch: %v\n", keys[2], node6Branch.Value(keys[2]))
